...
$stmt = $pdo->prepare('SELECT * FROM barang2 ORDER BY id LIMIT :current_page, :record_per_page');
$stmt->bindValue(':current_page', ($page-1)*$records_per_page, PDO::PARAM_INT);
$stmt->bindValue(':record_per_page', $records_per_page, PDO::PARAM_INT);
$stmt->execute();
$brang = $stmt->fetchAll(PDO::FETCH_ASSOC);

$num_brang = $pdo->query('SELECT COUNT(*) FROM barang2')->fetchColumn();
?>
...
<div class="content read">
	<h2>Inventaris Lab. Psikologi Lanjutan</h2>
